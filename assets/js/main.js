...
var main = (function($) { var _ = {
	...
	show: function() {		
		if (breakpoints.active('<=xsmall')) 
			// If xsmall, always hide caption when showing the wrapper.
			_.hideCaption();
		else 
			// If not xsmall, always show the caption.
			_.showCaption();
	...
	hide: function() {
		if (breakpoints.active('<=xsmall')) 
			// If xsmall, always show caption when hiding the wrapper.
			_.showCaption();
		else 
			// If not xsmall, always show the caption.
			_.showCaption();
	...
	showCaption: function() {
		$slideCaption = $('#viewer .slide .caption');
		$slideCaption.show();
	},
